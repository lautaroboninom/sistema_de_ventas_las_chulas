...
def _set_audit_user(request):
    """Set per-request audit user in PostgreSQL session vars.

    Kept local to avoid importing `service.views` (which can create
    circular imports during test/module bootstrap).
    """
