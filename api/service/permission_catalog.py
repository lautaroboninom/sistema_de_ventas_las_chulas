...
PERMISSION_CATALOG = [
    ...
    {'code': 'page.promociones', 'label': 'Ver promociones', 'type': 'page', 'group': 'Paginas'},
    ...
    {'code': 'action.promociones.editar', 'label': 'Gestionar promociones', 'type': 'action', 'group': 'Promociones'},
