...
export default function CatalogoMarcas() {
  ...
  async function guardarVariante(modelId) {
    ...
    try {
      setLoading(true); setErr(""); setMsg("");
      await patchModeloVariante(sel.id, modelId, varianteText);
  ...
  return (
    <div className="grid md:grid-cols-2 gap-6">
      {/* IZQUIERDA: Marcas + t̩cnico de marca */}
      <div>
        ...
        {sel && (
          <form onSubmit={addModelo} className="border rounded p-3 mb-3 grid grid-cols-1 md:grid-cols-5 gap-2 items-end">
            ...
            <div>
              ...
              <Input placeholder="p.ej. 25T" value={fmo.variante || ""} onChange={(e) => setFmo((f) => ({ ...f, variante: e.target.value }))} />
            </div>
